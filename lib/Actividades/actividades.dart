...
class _ActividadState extends State<Actividad> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    // Registro la primera pestaña como visitada al inicializar el widget
    ...
    // Inicializo el TabController según la cantidad de secciones disponibles
        ...
        children: [
          ...
          Positioned(
            ...
            child: Opacity(
              opacity: opacidad(1),
              child: Image.asset(
                'assets/Actividades/Fondo_superior_Derecha.png',
          ...
          Positioned(
            ...
            child: Opacity(
              opacity: opacidad(1),
              child: Image.asset(
                'assets/Actividades/Fondo_Supeior_Izquierda.png',
                width: esPantallaPequena ? 120 : 250,
          ...
          Positioned(
            ...
            child: Opacity(
              opacity: opacidad(1),
              child: Image.asset(
                'assets/Actividades/Fondo_inferior_Izquierda.png',
                width: esPantallaPequena ? 120 : 250,
                //height: MediaQuery.of(context).size.width * 0.18,
                fit: BoxFit.contain,
              ),
          ...
          Positioned(
            ...
            child: Opacity(
              opacity: opacidad(1),
              child: Image.asset(
                'assets/Actividades/Fondo_Inferior_Derecha.png',
                width: esPantallaPequena ? 120 : 250,
                //height: MediaQuery.of(context).size.width * 0.18,
                fit: BoxFit.contain,
              ),
            ...
            child: ElevatedButton.icon(
              onPressed: () {
                ...
                if (_index > 0) {
                  ...
                  // Si estoy en la primera sección, navego a la pantalla de Cronograma
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => const Cronograma(),
                    ),
                  );
                }
              },
            ...
            child: ElevatedButton.icon(
              onPressed: () async {
                ...
                if (_index < secciones.length - 1) {
                  ...
                  // Si ya es la última sección, navego a la pantalla de Bibliografía
                  Navigator.push(
                    context,
                    MaterialPageRoute(
...
// Muestra un menú modal inferior con acceso a las diferentes secciones
  void modalmenu(BuildContext context) {
    showModalBottomSheet(
      ...
      // Fondo transparente para personalizar el contenedor interno
